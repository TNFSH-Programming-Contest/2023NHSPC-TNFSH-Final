...
| memory_limit |  256 | 512 | 256 | 256 | 256 |
| time_limit |  1.0 | 1.0 | 0.5 | 0.5 | 1.0 |
...
| D | 15<br>$a_{i, j} \in \{-1, 1\}$，至少有一個 $a_{i, j} = 1$ | 23<br>$N \times M \leq 50$ | 27<br>$N \times M \leq 2000$ | 35<br>無額外限制 |
...
| 32 | 2 | (A1, D1) (A4, D1) |
| 34 | 2 | (A1, A4) (C1, D3) |
| 35 | 4 | (A1, C2) (A4, C2) (D4) (E1) |
| 38 | 2 | (A2, D1) (D1, D2) |
| 39 | 2 | (A1, C1, D1) (A4, C1, D1) |
| 40 | 5 | (C1, C2, D1) (A1, A2) (A2, A4) (A1, D2) (A4, D2) |
| 41 | 3 | (A1, A4, C1) (A2, C2) (C2, D2) |
| 42 | 5 | (A1, C1, C2) (A4, C1, C2) (D1, D3) (C1, D4) (C1, E1) |
| 44 | 2 | (A1, D3) (A4, D3) |
| 45 | 3 | (A2, C1, D1) (C1, D1, D2) (C2, D3) |
| 47 | 4 | (A1, A2, C1) (A2, A4, C1) (A1, C1, D2) (A4, C1, D2) |
| 48 | 2 | (A2, C1, C2) (C1, C2, D2) |
| 49 | 2 | (A1, A4, D1) (C1, D1, D3) |
| 50 | 7 | (A1, C2, D1) (A4, C2, D1) (A2, D3) (D2, D3) (D1, D4) (D1, E1) (A3, C1) |
| 51 | 2 | (A1, C1, D3) (A4, C1, D3) |
| 52 | 6 | (A1, A4, C2) (C1, C2, D3) (A1, D4) (A4, D4) (A1, E1) (A4, E1) |
| 53 | 3 | (A2, C1, D2) (C2, D4) (C2, E1) |
| 55 | 4 | (A1, A2, D1) (A2, A4, D1) (A1, D1, D2) (A4, D1, D2) |
| 56 | 2 | (A2, C2, D1) (C2, D1, D2) |
| 57 | 6 | (A1, A2, A4) (A1, A4, D2) (A2, C1, D3) (C1, D2, D3) (C1, D1, D4) (C1, D1, E1) |
| 58 | 9 | (A1, A2, C2) (A2, A4, C2) (A1, C2, D2) (A4, C2, D2) (A2, D4) (D2, D4) (A2, E1) (D2, E1) (A3, D1) |
| 59 | 6 | (A1, D1, D3) (A4, D1, D3) (A1, C1, D4) (A4, C1, D4) (A1, C1, E1) (A4, C1, E1) |
| 60 | 5 | (C2, D1, D3) (C1, C2, D4) (C1, C2, E1) (A1, A3) (A3, A4) |
| 61 | 3 | (A2, D1, D2) (A1, A4, D3) (A3, C2) |
| 62 | 4 | (A1, C2, D3) (A4, C2, D3) (D3, D4) (D3, E1) |
| 63 | 2 | (A1, A2, D2) (A2, A4, D2) |
| 65 | 8 | (A2, D1, D3) (D1, D2, D3) (A2, C1, D4) (C1, D2, D4) (A2, C1, E1) (C1, D2, E1) (A3, C1, D1) (E2) |
| 66 | 2 | (A2, A3) (A3, D2) |
| 67 | 10 | (A1, A2, D3) (A2, A4, D3) (A1, D2, D3) (A4, D2, D3) (A1, D1, D4) (A4, D1, D4) (A1, D1, E1) (A4, D1, E1) (A1, A3, C1) (A3, A4, C1) |
| 68 | 5 | (A2, C2, D3) (C2, D2, D3) (C2, D1, D4) (C2, D1, E1) (A3, C1, C2) |
| 69 | 4 | (A1, A4, D4) (C1, D3, D4) (A1, A4, E1) (C1, D3, E1) |
| 70 | 6 | (A1, C2, D4) (A4, C2, D4) (A1, C2, E1) (A4, C2, E1) (D4, E1) (A3, D3) |
| 73 | 7 | (A2, D2, D3) (A2, D1, D4) (D1, D2, D4) (A2, D1, E1) (D1, D2, E1) (A2, A3, C1) (A3, C1, D2) |
| 75 | 11 | (A1, A2, D4) (A2, A4, D4) (A1, D2, D4) (A4, D2, D4) (A1, A2, E1) (A2, A4, E1) (A1, D2, E1) (A4, D2, E1) (A1, A3, D1) (A3, A4, D1) (C3) |
| 76 | 5 | (A2, C2, D4) (C2, D2, D4) (A2, C2, E1) (C2, D2, E1) (A3, C2, D1) |
| 77 | 5 | (D1, D3, D4) (D1, D3, E1) (C1, D4, E1) (A1, A3, A4) (A3, C1, D3) |
| 78 | 4 | (A1, A3, C2) (A3, A4, C2) (A3, D4) (A3, E1) |
| 79 | 4 | (A1, D3, D4) (A4, D3, D4) (A1, D3, E1) (A4, D3, E1) |
| 80 | 3 | (C2, D3, D4) (C2, D3, E1) (D1, E2) |
| 81 | 4 | (A2, D2, D4) (A2, D2, E1) (A2, A3, D1) (A3, D1, D2) |
| 82 | 3 | (A1, E2) (A4, E2) (C1, C3) |
| 83 | 5 | (A1, A2, A3) (A2, A3, A4) (A1, A3, D2) (A3, A4, D2) (C2, E2) |
| 84 | 2 | (A2, A3, C2) (A3, C2, D2) |
| 85 | 8 | (A2, D3, D4) (D2, D3, D4) (A2, D3, E1) (D2, D3, E1) (D1, D4, E1) (A3, D1, D3) (A3, C1, D4) (A3, C1, E1) |
| 87 | 5 | (A1, D4, E1) (A4, D4, E1) (A1, A3, D3) (A3, A4, D3) (C1, D1, E2) |
| 88 | 4 | (C2, D4, E1) (A3, C2, D3) (A2, E2) (D2, E2) |
| 89 | 3 | (A2, A3, D2) (A1, C1, E2) (A4, C1, E2) |
| 90 | 2 | (C1, C2, E2) (C3, D1) |
| 92 | 3 | (D3, E2) (A1, C3) (A4, C3) |
| 93 | 7 | (A2, D4, E1) (D2, D4, E1) (A2, A3, D3) (A3, D2, D3) (A3, D1, D4) (A3, D1, E1) (C2, C3) |
| 95 | 6 | (A1, A3, D4) (A3, A4, D4) (A1, A3, E1) (A3, A4, E1) (A2, C1, E2) (C1, D2, E2) |
| 96 | 2 | (A3, C2, D4) (A3, C2, E1) |
| 97 | 4 | (D3, D4, E1) (A1, D1, E2) (A4, D1, E2) (C1, C3, D1) |
| 98 | 3 | (C2, D1, E2) (A2, C3) (C3, D2) |
| 99 | 4 | (A1, A4, E2) (C1, D3, E2) (A1, C1, C3) (A4, C1, C3) |
| 100 | 6 | (A1, C2, E2) (A4, C2, E2) (D4, E2) (E1, E2) (C1, C2, C3) (B1) |
| 101 | 4 | (A2, A3, D4) (A3, D2, D4) (A2, A3, E1) (A3, D2, E1) |
| 103 | 2 | (A2, D1, E2) (D1, D2, E2) |
| 105 | 8 | (A3, D3, D4) (A3, D3, E1) (A1, A2, E2) (A2, A4, E2) (A1, D2, E2) (A4, D2, E2) (A2, C1, C3) (C1, C3, D2) |
| 106 | 2 | (A2, C2, E2) (C2, D2, E2) |
| 107 | 6 | (D1, D3, E2) (C1, D4, E2) (C1, E1, E2) (A1, C3, D1) (A4, C3, D1) (B1, C1) |
| 108 | 2 | (A3, E2) (C2, C3, D1) |
| 109 | 4 | (A1, D3, E2) (A4, D3, E2) (A1, A4, C3) (C1, C3, D3) |
| 110 | 5 | (C2, D3, E2) (A1, C2, C3) (A4, C2, C3) (C3, D4) (C3, E1) |
| 113 | 3 | (A3, D4, E1) (A2, C3, D1) (C3, D1, D2) |
| 115 | 10 | (A2, D3, E2) (D2, D3, E2) (D1, D4, E2) (D1, E1, E2) (A3, C1, E2) (A1, A2, C3) (A2, A4, C3) (A1, C3, D2) (A4, C3, D2) (B1, D1) |
| 116 | 2 | (A2, C2, C3) (C2, C3, D2) |
| 117 | 9 | (A1, D4, E2) (A4, D4, E2) (A1, E1, E2) (A4, E1, E2) (C3, D1, D3) (C1, C3, D4) (C1, C3, E1) (A1, B1) (A4, B1) |
| 118 | 4 | (C2, D4, E2) (C2, E1, E2) (A3, C3) (B1, C2) |
| 119 | 2 | (A1, C3, D3) (A4, C3, D3) |
| 123 | 7 | (A2, D4, E2) (D2, D4, E2) (A2, E1, E2) (D2, E1, E2) (A3, D1, E2) (A2, B1) (B1, D2) |
| 124 | 2 | (A1, B1, C1) (A4, B1, C1) |
| 125 | 8 | (A1, A3, E2) (A3, A4, E2) (A2, C3, D3) (C3, D2, D3) (C3, D1, D4) (C3, D1, E1) (A3, C1, C3) (B1, C1, C2) |
| 127 | 7 | (D3, D4, E2) (D3, E1, E2) (A1, C3, D4) (A4, C3, D4) (A1, C3, E1) (A4, C3, E1) (B1, D3) |
| 128 | 2 | (C2, C3, D4) (C2, C3, E1) |
| 130 | 2 | (A2, B1, C1) (B1, C1, D2) |
| 131 | 2 | (A2, A3, E2) (A3, D2, E2) |
| 132 | 2 | (A1, B1, D1) (A4, B1, D1) |
| 133 | 6 | (A2, C3, D4) (C3, D2, D4) (A2, C3, E1) (C3, D2, E1) (A3, C3, D1) (B1, C2, D1) |
| 134 | 2 | (A1, A4, B1) (B1, C1, D3) |
| 135 | 8 | (D4, E1, E2) (A3, D3, E2) (A1, A3, C3) (A3, A4, C3) (A1, B1, C2) (A4, B1, C2) (B1, D4) (B1, E1) |
| 137 | 2 | (C3, D3, D4) (C3, D3, E1) |
| 138 | 2 | (A2, B1, D1) (B1, D1, D2) |
| 140 | 5 | (C3, E2) (A1, A2, B1) (A2, A4, B1) (A1, B1, D2) (A4, B1, D2) |
| 141 | 4 | (A2, A3, C3) (A3, C3, D2) (A2, B1, C2) (B1, C2, D2) |
| 142 | 3 | (B1, D1, D3) (B1, C1, D4) (B1, C1, E1) |
| 143 | 3 | (A3, D4, E2) (A3, E1, E2) (A3, B1) |
| 144 | 2 | (A1, B1, D3) (A4, B1, D3) |
| 145 | 3 | (C3, D4, E1) (A3, C3, D3) (B1, C2, D3) |
| 150 | 5 | (A2, B1, D3) (B1, D2, D3) (B1, D1, D4) (B1, D1, E1) (A3, B1, C1) |
| 152 | 4 | (A1, B1, D4) (A4, B1, D4) (A1, B1, E1) (A4, B1, E1) |
| 153 | 4 | (A3, C3, D4) (A3, C3, E1) (B1, C2, D4) (B1, C2, E1) |
| 157 | 2 | (A1, C3, E2) (A4, C3, E2) |
